...
with open("content/Pictory_2026-05-09.md", "r") as f:
    text = f.read()
...
# Extract Body and Social
body_start = text.find('## Review Body')
body_text = text[body_start + len('## Review Body'):].strip()
...
with open("blog/pictory-ai-2026.html", "w") as f:
