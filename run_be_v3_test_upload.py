...
# Use the V3 final video
VIDEO_PATH = "/root/.openclaw/workspace/content/broke_economist/v3_test/final.mp4"
JSON_PATH = "/root/.openclaw/workspace/content/broke_economist/v3_test/script.json"
