...
body = {
    "snippet": {
        "title": "Pipeline Test: Buy, Borrow, Die (George Voice)",
        "description": "Unlisted test of the Broke Economist daily pipeline.",
        "tags": ["finance", "test"],
        "categoryId": "27"
    },
    "status": {
...
media_yt = MediaFileUpload("be_pipeline_test.mp4", mimetype="video/mp4", resumable=True)
